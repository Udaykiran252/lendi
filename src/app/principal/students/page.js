    ...
    <>
      <style>{`
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .sb-inp:focus{border-color:rgba(167,139,250,.5)}
        ...
        .av{width:32px;height:32px;border-radius:9px;background:linear-gradient(135deg,rgba(167,139,250,.2),rgba(167,139,250,.07));display:flex;align-items:center;justify-content:center;font-size:11px;font-weight:800;color:#a78bfa}
