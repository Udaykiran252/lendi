...
export default function HodStudentsPage() {
  ...
  const filtered = students.filter(s => {
    ...
    return matchSearch && matchYear && matchSection && matchFilter;
  });
    ...
    <>
      ...
      <div className="root">
        ...
        <main className="main">
          ...
          <div className="page-sub">Department overview of student details and outpass activity</div>
          ...
          <div className="toolbar">
            <div className="sb-box">
              ...
              <input className="sb-inp" placeholder="Search by name or roll number..." value={search} onChange={e=>setSearch(e.target.value)}/>
            </div>
              ...
              <table>
                <thead>
                  <tr>
                    ...
                    <th>Outpass Status</th><th>Approved Outpasses</th>
                  </tr>
                </thead>
                <tbody>
                  {filtered.map(s => {
                    ...
                    return (
                      <tr key={s.user_id}>
                        ...
                        <td><span className="badge" style={{background:'rgba(74,222,128,.1)',color:'#4ade80'}}>{approved} ✓</span></td>
                      </tr>
                    );
                  })}
                </tbody>
